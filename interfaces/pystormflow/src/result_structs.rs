...
impl SectionalForcesInput {
    #[getter]
    pub fn circulation_strength(&self) -> Vec<Float> {
        self.data.circulation_strength.clone()
    }

    #[getter]
    pub fn velocity(&self) -> Vec<[Float; 3]> {
        self.data.velocity.iter().map(|v| v.0).collect()
    }

    #[getter]
    pub fn angles_of_attack(&self) -> Vec<Float> {
        self.data.angles_of_attack.clone()
    }

    #[getter]
    pub fn acceleration(&self) -> Vec<[Float; 3]> {
        self.data.acceleration.iter().map(|v| v.0).collect()
    }

    #[getter]
    pub fn rotation_velocity(&self) -> [Float; 3] {
...
impl IntegratedValues {
    #[getter]
    pub fn circulatory(&self) -> [Float; 3] {
        self.data.circulatory.0
    }

    #[getter]
    pub fn sectional_drag(&self) -> [Float; 3] {
        self.data.sectional_drag.0
    }

    #[getter]
    pub fn added_mass(&self) -> [Float; 3] {
        self.data.added_mass.0
    }

    #[getter]
    pub fn gyroscopic(&self) -> [Float; 3] {
        self.data.gyroscopic.0
    }

    #[getter]
    pub fn total(&self) -> [Float; 3] {
        self.data.total.0
    }
}
...
impl SimulationResult {
    ...
    #[getter]
    pub fn ctrl_points(&self) -> Vec<[Float; 3]> {
    ...
    #[getter]
    pub fn input_power(&self) -> Vec<Float> {
    ...
    pub fn integrated_forces_sum(&self) -> [Float; 3] {
        self.data.integrated_forces_sum().0
    }

    pub fn integrated_moments_sum(&self) -> [Float; 3] {
