...
- Automatic code documentation for core library [here](https://docs.rs/stormbird/0.9.0/stormbird/)
- Automatic code documentation for the math utilities [here](https://docs.rs/stormath/0.3.0/stormath/)
