...
if __name__ == "__main__":
    ...
    for case in cases:
        print("Testing case: ", case.to_string())
        ...
        ax1.plot(ctrl_points_z, -circulation_strength, label=case.to_string())

        ax1.set_ylim(0, None)

        ax1.set_xlabel("Ctrl point z")
        ax1.set_ylabel("Circulation strength")
